...
The value of the flow in each edge will actually not stored, but it is easy to extend the implementation - by using an additional matrix - to also store the flow and return it.
