...
(Note that we are using one-based indexing.)
...
3. This continues until it "jumps" from $[1, g(g( \dots g(r)-1 \dots -1)-1)]$ to $[g(-1), -1]$; this is where the `sum` function stops jumping.
