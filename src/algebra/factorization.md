...
This algorithm is also known as the [Tortoise and Hare algorithm](data_structures/hare_tortoise_algorithm.md), based on the tale in which a tortoise (here a slow pointer) and a hare (here a faster pointer) make a race.

src/data_structures/hare_tortoise_algorithm.md
